...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;background-color:#363636;i"mySidebar"><br>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-row-padding">
    <div class="img_logo">
        <img src="img/contato.jpg" alt="Contato" width="1000px">
    </div>
  </div>
