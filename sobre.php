...
<div class="w3-container" id="programa" style="color:white">
    ...
    <p>Nossa equipe é composta por 80 colaboradores que estão distribuídos entre as unidades,sendo eles profissionais que realizam desde o atendimento até a manutenção. <br> <br>Matriz - 30 funcionários<br>Filial 01 - 10 funcionários<br>Filial 02 - 10 funcionários<br>Filial 03 - 10 funcionários<br>Filial 04 - 20 funcionários
    </p>
</div>
<div class="w3-container" id="programa" style="margin-top:40px;color:white">
    <h1 class="w3-xxxlarge w3-text-white"><b>Horário de Atendimento</b></h1>
    <p>Segunda a Sexta: 08:00h - 11:30 / 13:30 - 18:00 <br> Sábados: 08:30 - 17:00
    </p>
</div>
